...
uint256 hashGenesisBlock("0x26e77cb5fcd179167668dcd00e524c6be2cb743c4af054cac4480b3651429133");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight >= 480001)
    {
       nSubsidy = 156.25 * COIN;
        }
    if(nHeight >= 720000)
    {
       nSubsidy = 78.125 * COIN;
        }
    if(nHeight >= 960000)
    {
       nSubsidy = 39.0625 * COIN;
        }
    if(nHeight >= 1200000)
    {
       nSubsidy = 19.53125 * COIN;
        }
    if(nHeight >= 1440000)
    {
       nSubsidy = 9.765625 * COIN;
        }
    if(nHeight >= 1680000)
    {
       nSubsidy = 4.8828125 * COIN;
        }
    if(nHeight >= 1920000)
    {
       nSubsidy = 2.44140625 * COIN;
        }
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Litecoin: 3.5 days
static const int64 nTargetSpacing = 120; // Litecoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2889aa27200cbefb3d172489d0fbc0d9e734522c57ab792c87e5c4f2e0b6bb75");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "SA MATAO PACO";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389391416;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388972216;

        if (fTestNet)
        {
            block.nTime    = 1389378931;
            block.nNonce   = 388972216;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x76a692c87e4dbad6b57011334c3021a196d939e51f4d11be4f39bdf1dd89d2a1"));
